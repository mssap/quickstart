		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#boschcoquickstart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"boschcoquickstart-display": {
								"semanticObject": "boschcoquickstart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bosch.co.quickstart",
									"url": sap.ui.require.toUrl("bosch/co/quickstart")
								}
							}
						}
					}
